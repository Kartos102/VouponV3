...
{
    public class SalesHistoryRedemptionWithDateQuery : IRequest<ApiResponseViewModel>
    {
        public int MerchantId { get; set; }  
        public DateTime StartDate { get; set; }
        public DateTime EndDate { get; set; }
    }
    public class SalesHistoryRedemptionWithDateQueryHandler : IRequestHandler<SalesHistoryRedemptionWithDateQuery, ApiResponseViewModel>
    {
        RewardsDBContext rewardsDBContext;
        public SalesHistoryRedemptionWithDateQueryHandler(RewardsDBContext rewardsDBContext)
        {
            this.rewardsDBContext = rewardsDBContext;
        }

        public async Task<ApiResponseViewModel> Handle(SalesHistoryRedemptionWithDateQuery request, CancellationToken cancellationToken)
        {
