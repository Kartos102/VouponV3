...
{
    public class CreateOrderItemWithQuantityPerMerchantAdminRefund : IRequest<ApiResponseViewModel>
    {
        ...
        public class CreateOrderItemWithQuantityPerMerchantAdminRefundHandler : IRequestHandler<CreateOrderItemWithQuantityPerMerchantAdminRefund, ApiResponseViewModel>
        {
            RewardsDBContext rewardsDBContext;
            VodusV2Context vodusV2Context;
            IOptions<AppSettings> appSettings;
            public CreateOrderItemWithQuantityPerMerchantAdminRefundHandler(RewardsDBContext rewardsDBContext, VodusV2Context vodusV2Context, IOptions<AppSettings> appSettings)
            {
            ...
            public async Task<ApiResponseViewModel> Handle(CreateOrderItemWithQuantityPerMerchantAdminRefund request, CancellationToken cancellationToken)
            {
