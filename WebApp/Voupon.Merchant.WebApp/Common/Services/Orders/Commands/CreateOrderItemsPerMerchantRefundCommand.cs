...
{
    public class CreateOrderItemsPerMerchantRefundCommand : IRequest<ApiResponseViewModel>
    {
        ...
        public class CreateOrderItemsPerMerchantRefundCommandHandler : IRequestHandler<CreateOrderItemsPerMerchantRefundCommand, ApiResponseViewModel>
        {
            RewardsDBContext rewardsDBContext;
            VodusV2Context vodusV2Context;
            IOptions<AppSettings> appSettings;
            public CreateOrderItemsPerMerchantRefundCommandHandler(RewardsDBContext rewardsDBContext, VodusV2Context vodusV2Context, IOptions<AppSettings> appSettings)
            {
            ...
            public async Task<ApiResponseViewModel> Handle(CreateOrderItemsPerMerchantRefundCommand request, CancellationToken cancellationToken)
            {
