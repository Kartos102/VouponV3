            ...
            foreach (IFormFile file in request.Files)
            {
                if (file.Length == 0)
                {
                    ...
                    if (temp != null)
                    {
                        ...
                        if (i < 10)
                        {
                             filename = "0" + i + "_" + Guid.NewGuid() + "." + contentType;

                        }
                        else
                        {
                             filename = i + "_" + Guid.NewGuid() + "." + contentType;
                ...
                else
                {
                    ...
                    if (i < 10)
                    {
                         name = "0" + i + "_" + Guid.NewGuid() + "." + contentType;

                    }
                    else
                    {
                         name = i + "_" + Guid.NewGuid() + "." + contentType;
                    ...
                    using (MemoryStream ms = new MemoryStream())
                    {
                        ...
                        if (i < 10)
                        {
                            filename = "0" + i + "_" + Guid.NewGuid() + "." + contentTypeOriginalImage;

                        }
                        else
                        {
                            filename = i + "_" + Guid.NewGuid() + "." + contentTypeOriginalImage;
