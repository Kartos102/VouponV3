...
{
    public class GetAdminUnreadedMessagesCountFromMerchants : IRequest<ApiResponseViewModel>
    {
        //public string UserId { get; set; }
    }

    public class GetAdminUnreadedMessagesCountFromMerchantsHandler : IRequestHandler<GetAdminUnreadedMessagesCountFromMerchants, ApiResponseViewModel>
    {
        RewardsDBContext rewardsDBContext;
        public GetAdminUnreadedMessagesCountFromMerchantsHandler(RewardsDBContext rewardsDBContext)
        {
            this.rewardsDBContext = rewardsDBContext;
        }

        public async Task<ApiResponseViewModel> Handle(GetAdminUnreadedMessagesCountFromMerchants request, CancellationToken cancellationToken)
        {
