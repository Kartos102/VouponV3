...
{
    public class GetAdminAllChats : IRequest<ApiResponseViewModel>
    {
        //public string UserId { get; set; }
    }

    public class GetAdminAllChatsHandler : IRequestHandler<GetAdminAllChats, ApiResponseViewModel>
    {
        RewardsDBContext rewardsDBContext;
        public GetAdminAllChatsHandler (RewardsDBContext rewardsDBContext)
        {
            this.rewardsDBContext = rewardsDBContext;
        }

        public async Task<ApiResponseViewModel> Handle(GetAdminAllChats request, CancellationToken cancellationToken)
        {
            ...
            try
            {
                ...
                if (chatGroups != null)
                {
                    ...
                    foreach (var chatGroupUser in listChatGroup)
                    {
                        ...
                        //chat.LastChat = lastmessages.CreatedAt;
                        if (!IsExecluded)
                        {
