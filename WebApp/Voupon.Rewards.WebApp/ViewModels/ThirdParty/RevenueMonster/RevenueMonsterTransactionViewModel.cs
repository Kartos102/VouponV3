...
namespace Voupon.Rewards.WebApp.ViewModels.ThirdParty.RevenueMonster.Transaction
{
    
    public partial class RevenueMonsterTransactionResponseViewModel
    {
    ...
    public partial class RevenueMonsterRefundCallback
    {
        public static RevenueMonsterRefundCallback FromJson(string json) => JsonConvert.DeserializeObject<RevenueMonsterRefundCallback>(json, Converter.Settings);
    }

    public static class Serialize
    {
        public static string ToJson(this RevenueMonsterRefundCallback self) => JsonConvert.SerializeObject(self, Converter.Settings);
    }
